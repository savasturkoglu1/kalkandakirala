...
function Datepicker() {
	...
	this.regional[ "" ] = { // Default regional settings
        ...
        monthNames: [ "Ocak","Şubat","Mart","Nisan","Mayıs","Haziran",
            "Temmuz","Agustos","Eylül","Ekim","Kasım","Aralık" ], // Names of months for drop-down and formatting
        monthNamesShort: [ "Ock", "Şbt", "Mrt", "Nis", "May", "Haz", "Tem", "Ags", "Eyl", "Ek", "Kas", "Arl" ], // For formatting
        dayNames: [ "Pazar", "Pazartesi", "Salı", "Çarşamba", "Perşembe", "Cuma", "Cumartesi" ], // For formatting
        dayNamesShort: [ "Pzr", "Psz", "Salı", "Çar", "Perş", "Cum", "Cmts" ], // For formatting
        dayNamesMin: [ "Pz","Pt","Sl","Çş","Pş","Cu","Cm" ], // Column headings for days starting at Sunday
