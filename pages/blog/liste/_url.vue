...
export default {
    ...
    components: { Unit, Subs },
     ...
     head() {
            return {
                title: this.kat.seo.seo_baslik,
               meta: [
                 { hid: 'description', name: 'description', content: this.kat.seo.seo_aciklama },
                 { hid: 'keywords', name: 'keywords', content: this.kat.seo.seo_keywords},
                ...
                { property:"og:title" , content:this.kat.seo.seo_baslik },
                { property:"og:description" , content:this.kat.seo.seo_aciklama },
                ...
                { name:"twitter:title" , content:this.kat.seo.seo_baslik },
       ...
       async asyncData ({$axios, params, route}) {          
         ...
         let data  = await $axios.get('/blog-list/'+params.url).then(res => { return res.data; });
         let kat =   await $axios.get('/blog-kategori/'+params.url).then(resp => { return resp.data });
